    ...
    <main class="flex-auto -mx-8">
            ...
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div class="lg:grid lg:grid-cols-12 lg:gap-x-8 lg:gap-y-20">
                    <div class="relative z-10 mx-auto max-w-2xl lg:col-span-7 lg:max-w-none lg:pt-6 xl:col-span-6">
                        <h1 class="text-4xl font-medium tracking-tight text-gray-900">Invest at the perfect time.</h1>
                        ...
                        <div class="mt-8 flex flex-wrap gap-x-6 gap-y-4"><a aria-label="Download on the App Store"
                                ...
                                class="inline-flex justify-center rounded-lg border py-[calc(theme(spacing.2)-1px)] px-[calc(theme(spacing.3)-1px)] text-sm transition-colors border-gray-300 text-gray-700 hover:border-gray-400 active:bg-gray-100 active:text-gray-700/80"
                                variant="outline" color="gray" href="https://www.youtube.com/watch?v=dQw4w9WgXcQ"><svg
                                    viewBox="0 0 24 24" fill="none" aria-hidden="true" class="h-6 w-6 flex-none">
                                    <circle cx="12" cy="12" r="11.5" stroke="#D4D4D4"></circle>
                                    <path
                                        d="M9.5 14.382V9.618a.5.5 0 0 1 .724-.447l4.764 2.382a.5.5 0 0 1 0 .894l-4.764 2.382a.5.5 0 0 1-.724-.447Z"
                                        fill="#A3A3A3" stroke="#A3A3A3"></path>
                                </svg><span class="ml-2.5">Watch the video</span></a></div>
                    </div>
                        ...
                        <div
                            ...
                            <div class="relative aspect-[366/729] mx-auto max-w-[366px]">
                                ...
                                <div
                                        ...
                                        <div class="mt-6 flex-auto rounded-t-2xl bg-white">
                                            <div class="p-4">
                                                <div class="flex gap-2">
                                                    <div class="text-xs leading-6 text-gray-500">Tailwind Labs, Inc.
                                                    </div>
                                                    <div class="text-sm text-gray-900">$CSS</div><svg
                                                        viewBox="0 0 24 24" class="ml-auto h-6 w-6" fill="none">
                                                    ...
                                                    <div
                                                        ...
                                                        <svg viewBox="0 0 286 208" class="overflow-visible">
                                                            <defs>
                                                                ...
                                                                <linearGradient id=":R3kl37qfja:-gradient"
                                                                    x1="0" x2="0" y1="0"
                                                                    y2="1">
                                                                    <stop offset="0%" stop-color="#13B5C8"></stop>
                                                                    <stop offset="100%" stop-color="#13B5C8"
                                                                        stop-opacity="0"></stop>
                                                                </linearGradient>
                                                            </defs>
                                                            <line stroke="#a3a3a3" opacity="0.1" x1="0"
                                                                y1="34.666666666666664" x2="286"
                                                                y2="34.666666666666664"></line>
                                                            <line stroke="#a3a3a3" opacity="0.1" x1="0"
                                                                y1="69.33333333333333" x2="286"
                                                                y2="69.33333333333333"></line>
                                                            <line stroke="#a3a3a3" opacity="0.1" x1="0"
                                                                y1="104" x2="286" y2="104"></line>
                                                            <line stroke="#a3a3a3" opacity="0.1" x1="0"
                                                                y1="138.66666666666666" x2="286"
                                                                y2="138.66666666666666"></line>
                                                            <line stroke="#a3a3a3" opacity="0.1" x1="0"
                                                                y1="173.33333333333331" x2="286"
                                                                y2="173.33333333333331"></line>
                                                            <rect y="32" width="270px" height="144"
                                                                fill="url(#:R3kl37qfja:-gradient)"
                                                                clip-path="url(#:R3kl37qfja:-clip)" opacity="0.5">
                                                            </rect>
                                                            <path
                                                                d="M 16.0000 32.0000L 23.9375 47.4709L 31.8750 39.3576L 39.8125 80.0116L 47.7500 63.6279L 55.6875 79.3140L 63.6250 87.8140L 71.5625 98.9128L 79.5000 71.6366L 87.4375 127.3372L 95.3750 120.1308L 103.3125 112.3023L 111.2500 120.2355L 119.1875 144.6337L 127.1250 176.0000L 135.0625 162.2326L 143.0000 144.3634L 150.9375 152.3953L 158.8750 144.6221L 166.8125 129.9535L 174.7500 103.3517L 182.6875 112.3401L 190.6250 136.2645L 198.5625 129.6337L 206.5000 120.0959L 214.4375 153.2965L 222.3750 136.5233L 230.3125 143.7035L 238.2500 132.5581L 246.1875 159.0494L 254.1250 144.2413L 262.0625 127.0233L 270.0000 103.2209"
                                                                fill="none" stroke-width="2"
                                                                stroke-linecap="round" stroke-linejoin="round"
                                                                pathLength="1" stroke-dashoffset="0px"
                                                                stroke-dasharray="1px 1px" stroke="#06b6d4"></path>
                                                        </svg>
                                                    </div>
                                                    <div
                                    ...
                                    <rect x="154" y="29" width="56" height="5" rx="2.5"
                                        fill="#D4D4D4"></rect>
                                </svg><img alt="" fetchpriority="high" width="366" height="729"
                    ...
                    <div class="relative -mt-4 lg:col-span-7 lg:mt-0 xl:col-span-6">
                        ...
                        <ul role="list"
                            ...
                            <li class="flex hidden xl:block"><img alt="CNN" loading="lazy" width="68"
                                    ...
                                    style="color:transparent" src="{{ asset('images/logos/cnn.svg') }}"></li>
                    ...
                    <div class="w-full flex-none snap-center px-4 sm:px-6">
                        <div class="relative transform overflow-hidden rounded-2xl bg-gray-800 px-5 py-6">
                            <div class="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2"><svg
                                    ...
                                    aria-hidden="true">
                                    <defs>
                                        <linearGradient id=":R1b57qfja:" x1="79" y1="16"
                                            x2="105" y2="237" gradientUnits="userSpaceOnUse">
                            ...
                            <div class="relative aspect-[366/729] relative mx-auto w-full max-w-[366px]">
                                ...
                                <div
                                    ...
                                    <rect x="154" y="29" width="56" height="5" rx="2.5"
                                        fill="#D4D4D4"></rect>
                                </svg><img alt="" loading="lazy" width="366" height="729"
                                    decoding="async" data-nimg="1"
                                    class="pointer-events-none absolute inset-0 h-full w-full"
                                    style="color:transparent" src="{{ asset('images/phone-frame.svg') }}">
                            </div>
                    ...
                    <div class="w-full flex-none snap-center px-4 sm:px-6">
                        <div class="relative transform overflow-hidden rounded-2xl bg-gray-800 px-5 py-6">
                            <div class="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2"><svg
                                    ...
                                    <defs>
                                        <linearGradient id=":R1j57qfja:" x1="79" y1="16"
                                            x2="105" y2="237" gradientUnits="userSpaceOnUse">
                                            <stop stop-color="#13B5C8"></stop>
                                            <stop offset="1" stop-color="#13B5C8" stop-opacity="0"></stop>
                                        </linearGradient>
                                            ...
                                            <div class="divide-y divide-gray-100">
                                                <div class="flex items-center gap-4 px-4 py-3">
                                                    <div class="flex-none rounded-full"
                                                        style="background-color:#F9322C"><svg viewBox="0 0 40 40"
                                                            fill="#fff" aria-hidden="true" class="h-10 w-10">
                                                            <path fill-rule="evenodd" clip-rule="evenodd"
                                                ...
                                                <div class="flex items-center gap-4 px-4 py-3">
                                                    <div class="flex-none rounded-full"
                                                        style="background-color:#5A67D8"><svg viewBox="0 0 40 40"
                                                            fill="#fff" aria-hidden="true" class="h-10 w-10">
                                                            <path fill-rule="evenodd" clip-rule="evenodd"
                                                ...
                                                <div class="flex items-center gap-4 px-4 py-3">
                                                    <div class="flex-none rounded-full"
                                                        style="background-color:#2A5B94"><svg viewBox="0 0 40 40"
                                                            fill="#fff" aria-hidden="true" class="h-10 w-10">
                                                            <path
                                                ...
                                                <div class="flex items-center gap-4 px-4 py-3">
                                                    <div class="flex-none rounded-full"
                                                        style="background-color:#3320A7"><svg viewBox="0 0 40 40"
                                                ...
                                                <div class="flex items-center gap-4 px-4 py-3">
                                                    <div class="flex-none rounded-full"
                                                        style="background-color:#2A3034"><svg viewBox="0 0 40 40"
                                                            fill="#fff" aria-hidden="true" class="h-10 w-10">
                                                            <path
                                                ...
                                                <div class="flex items-center gap-4 px-4 py-3">
                                                    <div class="flex-none rounded-full"
                                                        style="background-color:#0EA5E9"><svg viewBox="0 0 40 40"
                                                            fill="#fff" aria-hidden="true" class="h-10 w-10">
                                                            <path fill-rule="evenodd" clip-rule="evenodd"
                                                ...
                                                <div class="flex items-center gap-4 px-4 py-3">
                                                    <div class="flex-none rounded-full"
                                                        style="background-color:#16A34A"><svg viewBox="0 0 40 40"
                                                            fill="#fff" aria-hidden="true" class="h-10 w-10">
                                                            <path fill-rule="evenodd" clip-rule="evenodd"
                                                ...
                                                <div class="flex items-center gap-4 px-4 py-3">
                                                    <div class="flex-none rounded-full"
                                                        style="background-color:#8D8D8D"><svg viewBox="0 0 40 40"
                    ...
                    <div class="w-full flex-none snap-center px-4 sm:px-6">
                        <div class="relative transform overflow-hidden rounded-2xl bg-gray-800 px-5 py-6">
                            <div class="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2"><svg
                                    ...
                                    aria-hidden="true">
                                    <defs>
                                        <linearGradient id=":R1r57qfja:" x1="79" y1="16"
                                            x2="105" y2="237" gradientUnits="userSpaceOnUse">
                                            <stop stop-color="#13B5C8"></stop>
                                            <stop offset="1" stop-color="#13B5C8" stop-opacity="0"></stop>
                                        </linearGradient>
                            ...
                            <div class="absolute inset-x-0 bottom-0 bg-gray-800/95 p-6 backdrop-blur sm:p-10"><svg
                                    ...
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                        ...
                                        fill="#A3A3A3"></path>
                                    <path d="M7 22c0-4.694 3.5-8 8-8" stroke="url(#:R7r57qfja:-gradient)"
            ...
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 hidden md:mt-20 md:block">
                <div class="grid grid-cols-12 items-center gap-8 lg:gap-16 xl:gap-24">
                    <div class="relative z-10 order-last col-span-6 space-y-6" role="tablist"
                        ...
                        <div class="relative rounded-2xl transition-colors hover:bg-gray-800/30">
                            <div class="relative z-10 p-8"><svg viewBox="0 0 32 32" fill="none"
                                    ...
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                        d="M5 4a4 4 0 014-4h14a4 4 0 014 4v13h-2V4a2 2 0 00-2-2h-1.382a1 1 0 00-.894.553l-.448.894a1 1 0 01-.894.553h-6.764a1 1 0 01-.894-.553l-.448-.894A1 1 0 0010.382 2H9a2 2 0 00-2 2v24a2 2 0 002 2h4v2H9a4 4 0 01-4-4V4z"
                                        fill="#A3A3A3"></path>
                                    <path d="M7 22c0-4.694 3.5-8 8-8" stroke="url(#:Rrdl7qfja:-gradient)"
                                        stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                                    <path
                                        d="M21 20l.217-5.513a1.431 1.431 0 00-2.85-.226L17.5 21.5l-1.51-1.51a2.107 2.107 0 00-2.98 0 .024.024 0 00-.005.024l3.083 9.25A4 4 0 0019.883 32H25a4 4 0 004-4v-5a3 3 0 00-3-3h-5z"
                                        fill="#A3A3A3"></path>
                    ...
                    <div class="relative col-span-6">
                        <div class="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2"><svg
                                viewBox="0 0 558 558" width="558" height="558" fill="none"
                                aria-hidden="true" class="animate-spin-slower">
                                <defs>
        ...
        <section id="secondary-features" aria-label="Features for building a portfolio" class="py-20 sm:py-32">
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <ul role="list"
                    ...
                    <li class="rounded-2xl border border-gray-200 p-8"><svg viewBox="0 0 32 32" aria-hidden="true"
                            class="h-8 w-8">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                                d="M9 0a4 4 0 00-4 4v24a4 4 0 004 4h14a4 4 0 004-4V4a4 4 0 00-4-4H9zm0 2a2 2 0 00-2 2v24a2 2 0 002 2h14a2 2 0 002-2V4a2 2 0 00-2-2h-1.382a1 1 0 00-.894.553l-.448.894a1 1 0 01-.894.553h-6.764a1 1 0 01-.894-.553l-.448-.894A1 1 0 0010.382 2H9z"
                                fill="#737373"></path>
                            <path d="M12 25l8-8m0 0h-6m6 0v6" stroke="#171717" stroke-width="2"
                                stroke-linecap="round"></path>
                        ...
                        <p class="mt-2 text-gray-700">Whether it’s $1 or $1,000,000, we can put your money to work for
                            you.</p>
                    </li>
                    <li class="rounded-2xl border border-gray-200 p-8"><svg viewBox="0 0 32 32" aria-hidden="true"
                            class="h-8 w-8">
                            ...
                            <path fill-rule="evenodd" clip-rule="evenodd"
                                ...
                                fill="url(#:S2:-gradient)"></path>
                            <rect x="9" y="6" width="14" height="4" rx="1" fill="#171717"></rect>
                            <circle cx="16" cy="16" r="16" fill="#A3A3A3" fill-opacity="0.2"></circle>
                            <defs>
                                <linearGradient id=":S2:-gradient" x1="16" y1="12" x2="16"
                        ...
                        <h3 class="mt-6 font-semibold text-gray-900">Build a balanced portfolio</h3>
                        <p class="mt-2 text-gray-700">Invest in different industries to find the most opportunities to
                            win huge.</p>
                    </li>
                    <li class="rounded-2xl border border-gray-200 p-8"><svg viewBox="0 0 32 32" aria-hidden="true"
                            class="h-8 w-8">
                        ...
                        <p class="mt-2 text-gray-700">Get insider tips on big stock moves and act on them within
                            seconds.</p>
                    </li>
                    <li class="rounded-2xl border border-gray-200 p-8"><svg viewBox="0 0 32 32" fill="none"
                            aria-hidden="true" class="h-8 w-8">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                                d="M9 0a4 4 0 00-4 4v24a4 4 0 004 4h14a4 4 0 004-4V4a4 4 0 00-4-4H9zm0 2a2 2 0 00-2 2v24a2 2 0 002 2h14a2 2 0 002-2V4a2 2 0 00-2-2h-1.382a1 1 0 00-.894.553l-.448.894a1 1 0 01-.894.553h-6.764a1 1 0 01-.894-.553l-.448-.894A1 1 0 0010.382 2H9z"
                                fill="#737373"></path>
                        ...
                        <h3 class="mt-6 font-semibold text-gray-900">Profit from your network</h3>
                        <p class="mt-2 text-gray-700">Invite new insiders to get tips faster and beat even other Pocket
                            users.</p>
                    </li>
                    <li class="rounded-2xl border border-gray-200 p-8"><svg viewBox="0 0 32 32" aria-hidden="true"
                            class="h-8 w-8">
                        ...
                        <h3 class="mt-6 font-semibold text-gray-900">Encrypted and anonymized</h3>
                        <p class="mt-2 text-gray-700">Cutting-edge security technology that even the NSA doesn’t know
                            about keeps you hidden.</p>
                    </li>
                    <li class="rounded-2xl border border-gray-200 p-8"><svg viewBox="0 0 32 32" fill="none"
                            aria-hidden="true" class="h-8 w-8">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            <path fill-rule="evenodd" clip-rule="evenodd"
                                ...
                                fill="#171717"></path>
                            <path d="M10 12h12" stroke="#737373" stroke-width="2" stroke-linecap="square"></path>
                            <circle cx="16" cy="16" r="16" fill="#A3A3A3" fill-opacity="0.2">
                            </circle>
                        </svg>
                        <h3 class="mt-6 font-semibold text-gray-900">Portfolio tracking</h3>
                        <p class="mt-2 text-gray-700">Watch your investments grow exponentially, leaving other
                            investors in the dust.</p>
                    </li>
                </ul>
            </div>
        </section>
        <section id="get-free-shares-today" class="relative overflow-hidden bg-gray-900 py-20 sm:py-28">
            <div class="absolute left-20 top-1/2 -translate-y-1/2 sm:left-1/2 sm:-translate-x-1/2"><svg
                    ...
                    <defs>
                        <linearGradient id=":S3:" x1="79" y1="16" x2="105"
                            y2="237" gradientUnits="userSpaceOnUse">
            ...
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div
                        ...
                        <figure class="animate-fade-in rounded-3xl bg-white p-6 opacity-0 shadow-md shadow-gray-900/5"
                            ...
                            <blockquote class="text-gray-900">
                                <div class="flex"><svg viewBox="0 0 20 20" aria-hidden="true"
                                    ...
                                    </svg><svg viewBox="0 0 20 20" aria-hidden="true"
                                        class="h-5 w-5 fill-cyan-500">
                                        <path
                                            d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z">
                                        </path>
                    ...
                    <div class="animate-marquee space-y-8 py-4 hidden lg:block"
                        style="--marquee-duration: 22320ms;">
                        <figure class="animate-fade-in rounded-3xl bg-white p-6 opacity-0 shadow-md shadow-gray-900/5"
                            aria-hidden="false" style="animation-delay: 0s;">
                            <blockquote class="text-gray-900">
                                <div class="flex"><svg viewBox="0 0 20 20" aria-hidden="true"
            ...
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="relative">
                        <div class="grid grid-cols-2" id="headlessui-radiogroup-:R3d7qfja:" role="radiogroup">
                            <span
                                ...
                                id="headlessui-radio-:R3bd7qfja:" role="radio" aria-checked="true"
                                tabindex="0" data-headlessui-state="checked" data-checked="">Monthly</span><span
                                ...
                                id="headlessui-radio-:R5bd7qfja:" role="radio" aria-checked="false"
                                tabindex="-1" data-headlessui-state="">Annually</span>
                        </div>
                ...
                <div
                    ...
                    <section
                        ...
                        <p class="relative mt-5 flex text-3xl tracking-tight text-gray-900"><span
                                aria-hidden="false" class="transition duration-300">$7</span><span
                                aria-hidden="true"
